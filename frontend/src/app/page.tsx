  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/register"
              className="px-5 py-2.5 text-sm font-medium bg-gradient-to-r from-primary-600 to-purple-600 text-white rounded-xl hover:from-primary-500 hover:to-purple-500 transition-all shadow-lg shadow-primary-500/25 hover:shadow-primary-500/40"
            >
              Get Started
            </Link>
          </div>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 pt-24 pb-16">
        ...
        <p
          className="text-lg md:text-xl text-surface-400 text-center max-w-2xl mb-10 animate-fade-in"
        ...
        >
          <Link
            href="/register"
            className="group px-8 py-4 text-base font-semibold bg-gradient-to-r from-primary-600 to-purple-600 text-white rounded-2xl hover:from-primary-500 hover:to-purple-500 transition-all shadow-xl shadow-primary-500/30 hover:shadow-primary-500/50 flex items-center gap-2"
          >
            Start Free
          ...
          <Link
            href="/login"
            className="px-8 py-4 text-base font-semibold glass text-white rounded-2xl hover:bg-surface-800/60 transition-all flex items-center justify-center"
          >
            Sign In
          </Link>
        </div>
      ...
      {/* Footer */}
      <footer className="py-8 text-center text-sm text-surface-500 border-t border-surface-800/50">
